...
<div id="modal" class="bg-black/50 z-10 w-full h-full absolute" style="display: none">
    <div class="w-1/3 h-9/12 pb-10 pt-4 bg-white absolute left-1/3 mt-8 rounded-xl">
        <form method="POST" action="/inventarisRuangan" class="grid pl-10 gap-1.5">
            @csrf
  ...
  <div class="ml-10 mt-9">
    <span class="text-2xl font-semibold mb-7">Daftar Barang - Inventaris Ruangan</span>
    ...
    <table class="mt-7 text-center rounded-xl">
         ...
         <tbody class="bg-gray-200">
            ...
            <td>{{ $p->jml_barang }}</td>
            <td class="pl-4 w-80 text-left overflow-hidden whitespace-nowrap text-ellipsis inline-block pt-2">{{ $p->kondisi_barang }}</td>
            <td><a href="">...</a></td>
         </tbody>
         @endforeach
    </table>
